	...
	<div class="products">
		<div class="product_list_wrap">
            ...
            <%
                ...
                try {
                	String sql = "SELECT POST_ID, POST_TITLE, POST_CAPTION, PICTURE_URL, REGISTER_DATE, USER_ID, ADMIN_ID, POST_SUBTITLE, TAG_ID FROM TOP_CLOTHES WHERE POST_TITLE = 'Stussy' AND ADMIN_ID='A002'";;
