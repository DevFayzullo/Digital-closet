	...
	<div class="products">
		<div class="product_list_wrap">
			<div class="product_list">
                ...
                try {
                    String sql = "select POST_ID, POST_TITLE, POST_CAPTION, PICTURE_URL, REGISTER_DATE, USER_ID, ADMIN_ID, POST_SUBTITLE, TAG_ID from SHOES WHERE POST_TITLE = 'Hoka' AND ADMIN_ID = 'A002'";
