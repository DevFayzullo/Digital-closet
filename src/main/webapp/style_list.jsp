...
<%
    ...
    try {
        String sql = "SELECT CP.POST_ID, CP.POST_TITLE, CP.POST_CAPTION, CP.PICTURE_URL, CP.REGISTER_DATE, " +
                     "CP.USER_ID, CP.ADMIN_ID, CP.POST_SUBTITLE, CP.TAG_ID, COUNT(UL.USER_ID) AS LIKE_COUNT " +
                     "FROM CLOTHES_POST CP " +
                     "LEFT JOIN USER_LIKES UL ON CP.POST_ID = UL.POST_ID " +
                     "CP.POST_ID, CP.POST_TITLE, CP.POST_CAPTION, CP.PICTURE_URL, CP.REGISTER_DATE, CP.USER_ID, CP.ADMIN_ID, CP.POST_SUBTITLE, CP.TAG_ID;
